                ...
                if(len(tokenizedline) == 8):
                    ...
                    if msg_type in ('1','2','3','18','19'):
                        ...
                        if msg_type in (1,2,3):
                            ...
                            #MMSI,lon,lat,datetime,messagetype,sog,cog
                            pipetokenizedtoken = tokenizedline[7].split("|")
                            outline = ",".join(tokenizedline[0:5]) + "," + pipetokenizedtoken[15] + "," + pipetokenizedtoken[19] + "\n"
                            ...
                            #MMSI,lon,lat,datetime,messagetype,sog,cog
                            pipetokenizedtoken = tokenizedline[7].split("|")
                            outline = ",".join(tokenizedline[0:5]) + "," + pipetokenizedtoken[19] + "," + pipetokenizedtoken[21] + "\n"
                            outfile.write(outline)
